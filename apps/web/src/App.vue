  ...
  <div class="app-root">
    ...
    <main class="app-shell">
      <TopBar
        ...
        @open-status="capabilityStatusVisible = true"
      ...
      <div class="main-layout">
        ...
        <section class="chat-area">
          ...
          <div class="chat-input-row">
            <button
              class="capability-entry-btn"
              title="小暖可以帮你"
              @click="capabilityVisible = true"
            >
              ✨
            </button>
            <ChatInput
              ...
              :voice="voice"
              :fill-text="capabilityFillText"
              @send="sendMessage"
              @filled="capabilityFillText = ''"
            />
          </div>
        </section>
      </div>
    ...
    <CapabilityPanel
      ...
      :user-id="userId"
      @close="capabilityVisible = false"
      @fill="capabilityFillText = $event"
    />

    <CapabilityStatus
      :visible="capabilityStatusVisible"
      @close="capabilityStatusVisible = false"
    />
...
const capabilityStatusVisible = ref(false);
const capabilityFillText = ref('');
...
/* Capability entry button — sits to the left of ChatInput */
.chat-input-row {
  display: flex;
  align-items: flex-end;
  gap: 0;
...
.capability-entry-btn:hover {
  background: rgba(250, 204, 21, 0.12);
  border-color: rgba(250, 204, 21, 0.25);
}

.chat-input-row :deep(.chat-input-area) {
  flex: 1;
}
</style>
